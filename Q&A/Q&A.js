...
class Card {
  ...
  _onClick() {
    console.log(this);
    return (
      typeof this._onClickCallback === "function" && this._onClickCallback()
    );
  }
...
class Preview {
  ...
  toggle() {
    document.querySelector(".preview").classList.toggle("preview_is-opened");
  }
  ...
  initialArray.forEach(item => {
    const card = new Card({
      ...
      handleLikeCallback: function() {
        preview.toggle();
        preview.changeImage(card.getSource());
      }
    });
